...
import { Zap, Eye, EyeOff, ArrowRight, Mail, Lock, User, Sparkles, ShieldCheck, Gauge, FlaskConical } from "lucide-react";
      ...
      <div className="auth-left">
        ...
        <div className="auth-hero">
          ...
          <p className="auth-subheadline">
            Catch bugs, security vulnerabilities, and performance issues before they reach production — powered by advanced AI.
          </p>
        </div>
        ...
        <div className="auth-card">
          ...
          <div className="mb-7">
            ...
            <p className="auth-form-sub">
              {mode === "login"
                ...
                : "Join thousands of developers using Codexa."}
            </p>
          </div>
          ...
          <div className="auth-social-row">
            <button
              ...
              onClick={() => onAuth({ name: "Demo User", email: "demo@codexa.ai" })}
            >
